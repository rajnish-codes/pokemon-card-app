...
<div className="transition-all transform bg-cyan-600  hover:rotate-3 hover:-translate-y-1 p-4 m-1 mt-4 
rounded-3xl shadow-amber-200 hover:shadow-xl animate-fade-in-up hover:scale-105 hover: shadow-lg 
 duration-200">
      ...
      <h2 className="text-lg font-semibold capitalize text-gray-600">{name}</h2>
